            ...
            <div class="section">
              <div class="mb20 clear" id="">
                <h1 class="heading inherit">
                  <a href="AndroidJNI.html">AndroidJNI</a>.SetBooleanArrayElement</h1>
                <div class="clear">
                </div>
              ...
              <div class="subsection">
                <div class="signature">
                  <div class="signature-CS sig-block">
                    ...
                    <h2>Declaration</h2>public static void <span class="sig-kw">SetBooleanArrayElement</span>(IntPtr <span class="sig-kw">array</span>,
int <span class="sig-kw">index</span>,
bool <span class="sig-kw">val</span>);
    </div>
                </div>
              </div>
              <div class="subsection">
                ...
                <table class="list">
                  <tr>
                    <td class="name lbl">array</td>
                    <td class="desc">The array of native booleans.</td>
                  </tr>
                  <tr>
                    <td class="name lbl">index</td>
                    <td class="desc">Index of the array element to set.</td>
                  </tr>
                  <tr>
                    <td class="name lbl">val</td>
                    <td class="desc">The value to set.</td>
                  </tr>
                </table>
              </div>
              <div class="subsection">
                <h3>Description</h3>
                <p>Sets the boolean value of one element in a primitive array.</p>
              </div>
              <div class="subsection">
        <p>This function is a special case of SetBooleanArrayRegion(), called with region size set to 1.<br /><br />See Also: <a href="http://download.oracle.com/javase/1.5.0/docs/guide/jni/spec/jniTOC.html">Java Native Interface Specification (Oracle)</a></p>
      </div>
              <hr class="section" />
              <div class="subsection">
                <div class="signature">
                  <div class="signature-CS sig-block">
                    <span style="color:red;">
                      <span class="tooltip">
                        ...
                        <span class="tooltiptext">AndroidJNI.SetBooleanArrayElement(IntPtr, int, byte) is obsolete. Use AndroidJNI.SetBooleanArrayElement(IntPtr, int, bool) method instead.</span>
                      </span>
                    </span>
                    <h2>Declaration</h2>public static void <span class="sig-kw">SetBooleanArrayElement</span>(IntPtr <span class="sig-kw">array</span>,
int <span class="sig-kw">index</span>,
byte <span class="sig-kw">val</span>);
    </div>
                </div>
              </div>
              <div class="subsection">
                ...
                <table class="list">
                  ...
                  <tr>
                    <td class="name lbl">val</td>
                    <td class="desc">The value to set - for 'true' use 1, for 'false' use 0.</td>
                  </tr>
                </table>
              </div>
              <div class="subsection">
              ...
              <div class="subsection">
        <p>This function is a special case of SetBooleanArrayRegion(), called with region size set to 1.<br /><br />This overload is obsolete. Use the overload that takes the bool <code class="tt">val</code> parameter instead.<br /><br />See Also: <a href="http://download.oracle.com/javase/1.5.0/docs/guide/jni/spec/jniTOC.html">Java Native Interface Specification (Oracle)</a></p>
      </div>
            </div>
            <div class="section">
              <div id="_content">
              ...
              <div class="footer clear">
                <div class="copy">
                  <p>
                    ...
                    <a href="https://issuetracker.unity3d.com">issuetracker.unity3d.com</a>.</p>Copyright ©2023 Unity Technologies. Publication Date: 2023-08-17.
                                        </div>
                <div class="menu">
...
<html lang="en" class="no-js">
  <head>
    ...
    <title>Unity - Scripting API: UIElements.PointerEventBase_1.twist</title>
        ...
        <div class="content-block">
          <div class="content">
            <div class="section">
              <div class="mb20 clear" id="">
                <h1 class="heading inherit">
                  <a href="UIElements.PointerEventBase_1.html">PointerEventBase&lt;T0&gt;</a>.twist</h1>
                <div class="clear">
                </div>
                <div class="scrollToFeedback">
                  <a id="scrollToFeedback">Leave feedback</a>
              ...
              <div class="subsection">
                <div class="signature">
                  <div class="signature-CS sig-block">
                    <span style="color:red;">
                    </span>public float <span class="sig-kw">twist</span>;
    </div>
                </div>
              </div>
              <div class="subsection">
...
<html lang="en" class="no-js">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Unity - Scripting API: EditorGUI.MaskField</title>
    <meta property="og:image" content="https://unity3d.com/files/images/ogimg.jpg" />
    <meta name="author" content="Unity Technologies" />
    <link rel="shortcut icon" href="https://unity.com/themes/contrib/unity_base/images/favicons/favicon.ico" />
    <link rel="icon" type="image/png" href="../../../StaticFiles/images/favicons/favicon.png" />
        ...
        <div class="content-block">
          <div class="content">
            <div class="section">
              <div class="mb20 clear" id="">
                <h1 class="heading inherit">
                  <a href="EditorGUI.html">EditorGUI</a>.MaskField</h1>
                <div class="clear">
                </div>
                <div class="scrollToFeedback">
                  <a id="scrollToFeedback">Leave feedback</a>
              ...
              <div class="subsection">
                <div class="signature">
                  <div class="signature-CS sig-block">
                    ...
                    <h2>Declaration</h2>public static int <span class="sig-kw">MaskField</span>(<a href="Rect.html">Rect</a> <span class="sig-kw">position</span>,
<a href="GUIContent.html">GUIContent</a> <span class="sig-kw">label</span>,
int <span class="sig-kw">mask</span>,
string[] <span class="sig-kw">displayedOptions</span>,
...
<a href="GUIStyle.html">GUIStyle</a> <span class="sig-kw">style</span> = EditorStyles.popup);
              ...
              <div class="subsection">
                ...
                <table class="list">
                  <tr>
                    <td class="name lbl">position</td>
                    <td class="desc">Rectangle on the screen to use for this control.</td>
                  </tr>
                  <tr>
                    <td class="name lbl">label</td>
                    <td class="desc">Label for the field.</td>
                  </tr>
                  <tr>
                    <td class="name lbl">mask</td>
                    <td class="desc">The current mask to display.</td>
                  </tr>
                  <tr>
                    <td class="name lbl">displayedOption</td>
                    <td class="desc">A string array containing the labels for each flag.</td>
                  </tr>
                  <tr>
                    <td class="name lbl">style</td>
                    <td class="desc">Optional <a href="GUIStyle.html">GUIStyle</a>.</td>
                  </tr>
                  <tr>
                    <td class="name lbl">displayedOptions</td>
                    <td class="desc">A string array containing the labels for each flag.</td>
                  </tr>
                </table>
              </div>
        ...
        The value modified by the user.
              ...
              <div class="subsection">
                <h3>Description</h3>
                <p>Makes a field for masks.</p>
              </div>
              <div class="subsection">
        <p>
          <strong>Note:</strong> The mask values for the flags associated with each option in the menu will be consecutive powers of 2 starting with 1, i.e. 1, 2, 4, 8, 16, and so on.<br /><br /><img src="../StaticFiles/ScriptRefImages/MaskField.png" /><br />
<em>Simple window that shows the mask field.</em></p>
      </div>
              <div class="subsection">
        <pre class="codeExampleCS">
using UnityEngine;
using <a href="UnityEditor.html">UnityEditor</a>;<br /><br />class SimpleMaskUsage : <a href="EditorWindow.html">EditorWindow</a>
{
    int flags = 0;
    string[] options = { "CanJump", "CanShoot", "CanSwim" };<br /><br />    [<a href="MenuItem.html">MenuItem</a>("Examples/Mask Field Usage")]
    static void Init()
    {
    ...
    {
        flags = <a href="EditorGUI.MaskField.html">EditorGUI.MaskField</a>(new <a href="Rect.html">Rect</a>(0, 0, 300, 20), "Player <a href="Unity.IO.LowLevel.Unsafe.AsyncReadManagerMetrics.Flags.html">Flags</a>", flags, options);
    }
}
</pre>
      </div>
